    ...
    with dataset_view, temp_identity:
        ...
        for chunk_view in dataset_view.as_chunks(kwargs['chunk_size']):
            ...
            arcpy.analysis.Identity(
                in_features=chunk_view.name, identity_features=temp_identity.path,
            ...
            attributes.update_by_function(temp_output_path, field_name, update_function,
...
def union(dataset_path, field_name, union_dataset_path, union_field_name, **kwargs):
    ...
    with dataset_view, temp_union:
        ...
        for chunk_view in dataset_view.as_chunks(kwargs['chunk_size']):
            temp_output_path = unique_path('output')
            arcpy.analysis.Union(in_features=[chunk_view.name, temp_union.path],
                                 out_feature_class=temp_output_path,
                                 join_attributes='all',
